// ConversationScreenInMy.dart (مُحدّث - حل المشكلات)
import 'dart:async';
import 'dart:io';
...
class _ConversationScreenInMyState extends State<ConversationScreenInMy> {
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text(
          ...
          style: TextStyle(
            fontFamily: AppTextStyles.appFontFamily,
            fontSize: AppTextStyles.medium,
            color: AppColors.textSecondary(_theme_controller_value()),
          ),
          textAlign: TextAlign.center,
        ),
        actions: [
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, idx) {
                        if (idx < serverMessages.length) {
                          ...
                          // حل المشكلة: جلب مدة الرسالة الصوتية تلقائياً
      ...
      child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Expanded(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            SizedBox(height: 6.h),
            if (widget.ad?.price != null) Text('${_formatPrice(widget.ad!.price!)}${" ليرة سورية".tr}', style: TextStyle(fontFamily: AppTextStyles.appFontFamily, fontSize: AppTextStyles.medium, fontWeight: FontWeight.bold, color: AppColors.textPrimary(_theme_controller_value()))),
          ]),
        ),
      ]),
    );
  ...
  Widget _buildMessageBubbleWithDelete(
    ...
    // حل المشكلة: استخدام المدة المخزنة في الكاش أو المدة الحالية
          ...
          Flexible(
            child: Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                SizedBox(height: 6.h),
                Align(alignment: Alignment.centerRight, child: Text(_formatDateTimeFull(message.createdAt), style: TextStyle(fontFamily: AppTextStyles.appFontFamily, fontSize: 10.sp, color: timeColor))),
              ]),
            ),
          ),
        ]),
  ...
  void _showTopContactMenu() {
    ...
    showMenu<int>(context: context, position: relativeRect, items: [
